...
class RegionsSingleImage{
	...
	/// Constructor: initialize the image for this set of ellipses as I
	RegionsSingleImage(IplImage *I);
	/// Destructor
	~RegionsSingleImage();

	/// Read the annotation from the file fName -- Pure virtual 
	virtual void read(std::string)=0;
	/// Read N annotations from the file stream fs -- Pure virtual 
