...
# where the binary is
my $evaluateBin = "d:/svn/Algorithm/jinmeng/Code/NS_Face/bin/VC2012/Win32/evaluate_fddb"; 
# where the images are
my $imDir = "Z:/User/team02/Face_DB/FDDB/originalPics"; 
# where the folds are
my $fddbDir = "z:/User/team02/Face_DB/FDDB/FDDB-folds"; 
# where the detections are
my $detDir = "z:/User/team02/jin/ns_face_finder01/FDDB/detection_model010_v1"; 
###########################
